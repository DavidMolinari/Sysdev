...
public class jdbc{
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        try {
            ...
            DBurl="jdbc:mysql://http://10.21.99.68:3306/CNAM";
            ...
            */
            ...
            try{
                  ...
                  while (resultats.next()) System.out.println(resultats.getString("nom")+" "+resultats.getString("prenom")+" "+resultats.getInt("age")+" "+resultats.getFloat("compte"));
